...
public class NumberPicker extends LinearLayout implements OnClickListener,
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        /**
         * RE: issue 6894  http://code.google.com/p/android/issues/detail?id=6894
         * If viewing this View in eclipse we can not instantiate its children. If this bug is fixed
