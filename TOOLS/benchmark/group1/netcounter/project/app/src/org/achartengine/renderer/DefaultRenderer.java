...
public class DefaultRenderer implements Serializable {
	...
	/** A text font. */
	public static final Typeface TEXT_FONT = Typeface.create(Typeface.DEFAULT, Typeface.BOLD);
	/** A text font for regular text, like the chart labels. */
	public static final Typeface REGULAR_TEXT_FONT = Typeface.create(Typeface.DEFAULT,
			Typeface.NORMAL);
