...
public class BarChart extends XYChart {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.achartengine.chart.XYChart#drawXLabels(java.util.List,
	 * java.lang.Double[], android.graphics.Canvas, android.graphics.Paint, int,
	 * int, double, double)
	 */
	@Override
	protected void drawXLabels(List<Double> xLabels, Double[] xTextLabelLocations, Canvas canvas,
		...
		super.drawXLabels(xLabels, xTextLabelLocations, canvas, paint, left, bottom,
				xPixelsPerUnit, minX);
	}
