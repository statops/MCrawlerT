    ...
    extends SgdFourmyStrategy
{
    ...
    private final static String TARGET_PACKAGE_ID = "org.totschnig.myexpenses";
    private final static String LAUNCHER_ACTIVITY_FULL_CLASSNAME = "org.totschnig.myexpenses.MyExpenses";
    private static String EXPECTED_INITIAL_STATE_ACTIVITY = "org.totschnig.myexpenses.MyExpenses";
