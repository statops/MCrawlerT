...
public class State extends IScenarioElement implements Cloneable {
	...
	public int hashCode() {
		...
		result = prime * result + ((mWidgets == null) ? 0 : mWidgets.hashCode());
		return result;
	}
	...
	public String getGraphStateId() {
		...
		return shortName(mName) + Scenario.IDSEPARATOR+widgINumber + finalId + hashcode.toString();
	}
	...
	public String toString() {
		...
		return mName + " id:" + mID + " type:" + mType + " ue:" + userEnvironment + " isFinal:" + isFinal
				+ " isInit: " + isInit;// + "\n wig:" + wig;
	}
