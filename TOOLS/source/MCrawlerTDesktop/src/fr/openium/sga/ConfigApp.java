...
public class ConfigApp {
	...
	public static final String COVERAGEPATH = File.separator
			+ "bin/coverage.xml";
	...
	public static final String TESTDATA_ALL_RV = File.separator
			+ "TestData/all_rv";
	public static final String TESTDATA_TESTED_RV = File.separator
			+ "TestData/tested_rv";
	public static final String TESTDATA_TO_PUSH = File.separator
			+ "TestData/rv";
	public static final String EMMAJAR = "emma.jar";
	public static final String ADBPATH = "platform-tools/adb";
	public static final String EMMAJARPATH = File.separator
			+ "tools/lib/emma.jar";
	...
	public static final String SCENARIO_REFINED_FILE = File.separator
			+ "r_scen.dot";
	...
	public static final String INTENTCRAWLER_TEST = ".test.IntentCrawler";
	public static final String INTENTXML = Config.INTENT_XML;
