 ...
 * 
 */
public class INJManagerTest {
	private static final String TAG = INJManagerTest.class.getName();

	@Test
	public void testInMethod() throws Exception {

		String[] params = new String[] { "inpuFile",
				"/Users/Stassia/Documents/Scen-genWorkSpace/sgd/input_file/NotePad/injTest" };
		...
		AbstractTaskManager inj = new INJRequestTaskManager(model, new File(env.getAllTestDataPath()), env);
