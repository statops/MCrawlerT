...
public class Refinement {
	...
	private SgaGraph mTraces = new SgaGraph();
	...
	private void addAll(HashSet<State> states) {
		mScenarioData.getStates().addAll(states);

	}

	private void addAll(ArrayList<Transition> transitions) {
		mScenarioData.getTransitions().addAll(transitions);
