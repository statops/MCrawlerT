...
public class PullCommand extends AbstractCommand implements ICommand {
	...
	public PullCommand(String adb, String emulateur, String fileToPull,
			String fileDestination) {
		mArgs = new String[] { adb, "-s", emulateur, "pull", fileToPull,
				fileDestination };
	}

	private Process pull;

	private volatile boolean pullchecker = false;
